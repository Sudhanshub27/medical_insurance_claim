  ...
  <div class="dashboard-wrapper">
    ...
    <aside id="dashboard-sidebar" class="dashboard-sidebar">
      ...
      <nav class="dashboard-sidebar__nav" style="padding-top: 24px;">
        ...
        <a href="#/my-claims" class="dashboard-nav-item active">${icon('clipboard', 18)} My Claims</a>
    ...
    <main class="dashboard-main">
      ...
      <div class="dashboard-content">
        <div style="margin-bottom:32px">
          <h1 style="margin-bottom:8px">My Claims</h1>
          <p class="subtitle">View and track all your past and active claims.</p>
        </div>
        ...
        <div class="card" style="padding:40px;text-align:center">
          ...
          <h3 style="margin-bottom:12px">No Other Active Claims</h3>
          <p style="color:var(--text-muted);max-width:400px;margin:0 auto 24px">You don't have any claims other than your recent MC25125 claim. Need to file a new one?</p>
          <a href="#/upload" class="btn btn--primary">Start New Claim</a>
        </div>
      </div>
    </main>
  </div>
