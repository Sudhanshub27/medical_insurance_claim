      ...
      <div class="tab-content active" id="login">
        <form onsubmit="window.handleLogin(event)">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;font-size:.85rem">
            ...
            <a href="#" style="color:var(--primary);font-weight:500" onclick="event.preventDefault();alert('Password reset link sent to your email!')">Forgot password?</a>
          </div>
        ...
        <button class="social-btn" onclick="alert('Google login would be integrated here')">
        ...
        <button class="social-btn" onclick="alert('Apple login would be integrated here')">
